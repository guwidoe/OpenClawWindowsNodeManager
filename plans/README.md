...
- **Phase 3 – Canvas, WebView & Browser Parity** (`plans/phase-3-canvas-browser.md`)
- **Phase 4 – Screen, Camera & Location** (`plans/phase-4-capture-sensors.md`)
...
- **Screen**: screen.record / screenshot → Phase 4

...
## Goal
Deliver a reliable, no-surprises Windows node companion that makes connect/disconnect safe, obvious, and repeatable for daily use.
...
- Pairing and token flows that are easy to complete and visible in the UI.
